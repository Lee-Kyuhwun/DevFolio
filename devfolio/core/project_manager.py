...
class ProjectManager:
    ...
    def save_project_draft(
        ...
        return self.rename_project(
            ...
            one_line_summary=updated_project.one_line_summary,
            summary=updated_project.summary,
            links=updated_project.links,
            overview=updated_project.overview,
            user_flow=updated_project.user_flow,
            tech_stack_detail=updated_project.tech_stack_detail,
            architecture=updated_project.architecture,
            features=updated_project.features,
            problem_solving_cases=updated_project.problem_solving_cases,
            performance_security_operations=updated_project.performance_security_operations,
